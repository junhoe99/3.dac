...
set_property IOSTANDARD LVCMOS18 [get_ports {m_dbg_signal[0]}]

# PORTC-16
set_property PACKAGE_PIN J5 [get_ports {m_dbg_signal[1]}]
set_property IOSTANDARD LVCMOS18 [get_ports {m_dbg_signal[1]}]

# PORTC-17
set_property PACKAGE_PIN E2 [get_ports {m_dbg_signal[2]}]
set_property IOSTANDARD LVCMOS18 [get_ports {m_dbg_signal[2]}]

# PORTC-18
set_property PACKAGE_PIN E3 [get_ports {m_dbg_signal[3]}]
set_property IOSTANDARD LVCMOS18 [get_ports {m_dbg_signal[3]}]

# PORTC-19
set_property PACKAGE_PIN G3 [get_ports {m_dbg_signal[4]}]
set_property IOSTANDARD LVCMOS18 [get_ports {m_dbg_signal[4]}]

# PORTC-20
set_property PACKAGE_PIN H3 [get_ports {m_dbg_signal[5]}]
set_property IOSTANDARD LVCMOS18 [get_ports {m_dbg_signal[5]}]

# PORTC-21
set_property PACKAGE_PIN D2 [get_ports {m_dbg_signal[6]}]
set_property IOSTANDARD LVCMOS18 [get_ports {m_dbg_signal[6]}]

# PORTC-22
set_property PACKAGE_PIN H2 [get_ports {m_dbg_signal[7]}]
set_property IOSTANDARD LVCMOS18 [get_ports {m_dbg_signal[7]}]
