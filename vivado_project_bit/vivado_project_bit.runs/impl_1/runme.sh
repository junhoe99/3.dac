...
HD_PWD='C:/Projects/2023/Single_Tx_Rx_System/3_dac_adc_triggered_read/vivado_project_bit/vivado_project_bit.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log xem7320_adc.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source xem7320_adc.tcl -notrace
