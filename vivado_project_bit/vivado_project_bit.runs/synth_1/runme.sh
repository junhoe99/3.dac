...
HD_PWD='C:/Projects/2023/Single_Tx_Rx_System/3_dac_adc_triggered_read/vivado_project_bit/vivado_project_bit.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log xem7320_adc.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source xem7320_adc.tcl
